...
def shortest_path(source, target):
    ...
    # add the source id to visited and queue
    visited.append(source)
    queue.append(source)
    parent = {}

    # links all the nodes that are visited to their earlier node

    root_movie = True
    while queue:
        # Pop first person on queue and check their neighbors
        # (1) remove
        ...
        try:
            ...
            neighbors = neighbors_for_person(current[1])
        ...
        for n in neighbors:
            ...
            if n[1] == target:
                ...
                #current node is the parent of end node
                path = []
                # n is the end node and current is its parent, n is not in the parent dict i think
            ...
            if n[1] not in visited:
                ...
                # if a neighbor has not been visited, they can be added to visited list and to the queue
                # all neighbors will have their parent node
                parent[n] = current
                visited.append(n[1])
